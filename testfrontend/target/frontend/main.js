...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.upload = function (name, blob) {
    ...
    AppComponent.prototype.uploadDoc = function (event) {
        var lastChunksize = 0;
        var file = event[0];
        this.readFile(file, lastChunksize, this.myCallback.bind(this));
    };
    AppComponent.prototype.myCallback = function (file, lastChunksize, result) {
    ...
    AppComponent.prototype.readFile = function (file, lastChunksize, callback) {
        var fileBlob = file.slice(lastChunksize, lastChunksize + 100000000);
        if (fileBlob.size != 0) {
            var fileReader_1 = new FileReader();
            fileReader_1.onloadend = function (result) {
                return callback(file, lastChunksize, fileReader_1.result);
            };
            fileReader_1.onload = function (result) {
                var text = fileReader_1.result;
                console.log('undefined');
            };
            var result = fileReader_1.readAsText(fileBlob);
...
module.exports = __webpack_require__(/*! /home/mkefi/Bureau/bnp/socle-test/testfrontend/src/main/testfrontend/src/main.ts */"./src/main.ts");
